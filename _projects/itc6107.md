...
description: "Distributed system for stock portfolio evaluation using Apache Kafka, Spark, and MySQL with real-time data streaming and financial analytics"
keywords: "big data, apache kafka, apache spark, distributed systems, stock analysis, portfolio evaluation, real-time streaming, financial analytics, mysql"
date: 2025-02-15
author: Christoforos Kapsalis
categories: [big-data, distributed-systems]
tags: [kafka, spark, mysql, distributed-systems, stock-analysis, real-time, financial-data]
---
